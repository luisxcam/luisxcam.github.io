...
var highcloud: objects.HighCloud;
var asteroidbelt: objects.AsteroidBelt;
var frigate: objects.Frigate;
var stats: Stats;
var alien = [];

//Game control
var currentScoreForBoss: number = constants.SCORE_FOR_NEW_BOSS;
var bulletWasShot: boolean = false;
var timesDefeatedBossLevel3: number = 0;
